...
%--------------------------------------------------------------------------
MonthReturn = ( portfValue(2:end,:) - portfValue(1:end-1,:) ) ./ portfValue(1:end-1,:);
rf = factorRet(:,9)
access_return = MonthReturn - rf
mu = geomean(access_return(:,1) + 1) - 1;
std= std(access_return);
sharp_ratio = mu/std;
